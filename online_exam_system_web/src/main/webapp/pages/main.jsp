...
<%--    	<script src="${pageContext.request.contextPath}/js/comCss.js"></script>--%>
<%--    	<script src="${pageContext.request.contextPath}/js/comJs.js"></script>--%>
<!--CSS start-->
<%--    <link rel="stylesheet"--%>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <img src="${pageContext.request.contextPath}/img/logo.jpg" width="100%" height="100%"/>
